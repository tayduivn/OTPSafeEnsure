...
public class GsonUtils {
    ...
    public static final String DEFAULT_DATE_PATTERN_1 = "yyyy-MM-dd HH:mm:ss";
    public static final String DEFAULT_DATE_PATTERN_2 = "yyyy-MM-dd'T'HH:mm:ss.SSS'Z'";
    public static final String DEFAULT_DATE_PATTERN_NO_SECOND = "yyyy-MM-dd HH:mm";
    /** 默认的 {@code JSON} 日期/时间字段的格式化模式。 */
