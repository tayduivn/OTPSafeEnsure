 ...
 * 手势解锁
 */
public class CustomLockViewOld extends View {
    //保存密码key
    ...
    //外圈大小
    private float mOuterRingWidth = 84;
    //内圆大小
    private float mInnerRingWidth = mOuterRingWidth / 6;
    ...
    public CustomLockViewOld(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomLockViewOld(Context context, AttributeSet attrs, int defStyleAttr) {
